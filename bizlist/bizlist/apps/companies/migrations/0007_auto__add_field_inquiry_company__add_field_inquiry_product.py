...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inquiry.company'
        db.add_column('companies_inquiry', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['companies.Company']), keep_default=False)

        # Adding field 'Inquiry.product'
        db.add_column('companies_inquiry', 'product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Product'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inquiry.company'
        db.delete_column('companies_inquiry', 'company_id')

        # Deleting field 'Inquiry.product'
        db.delete_column('companies_inquiry', 'product_id')
