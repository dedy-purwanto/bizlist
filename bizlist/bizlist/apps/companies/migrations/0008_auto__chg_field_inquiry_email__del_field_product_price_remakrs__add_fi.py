...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inquiry.email'
        db.alter_column('companies_inquiry', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255))

        # Deleting field 'Product.price_remakrs'
        db.delete_column('companies_product', 'price_remakrs')

        # Adding field 'Product.price_remarks'
        db.add_column('companies_product', 'price_remarks', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Inquiry.email'
        db.alter_column('companies_inquiry', 'email', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Adding field 'Product.price_remakrs'
        db.add_column('companies_product', 'price_remakrs', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Product.price_remarks'
        db.delete_column('companies_product', 'price_remarks')
