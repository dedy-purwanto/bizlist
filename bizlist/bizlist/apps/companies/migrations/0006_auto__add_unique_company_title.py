...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Company', fields ['title']
        db.create_unique('companies_company', ['title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Company', fields ['title']
        db.delete_unique('companies_company', ['title'])
