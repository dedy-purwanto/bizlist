...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('companies_inquiry', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Inquiry.email'
        db.add_column('companies_inquiry', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Inquiry.phone'
        db.add_column('companies_inquiry', 'phone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Inquiry.country'
        db.add_column('companies_inquiry', 'country', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Inquiry.message'
        db.add_column('companies_inquiry', 'message', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inquiry.name'
        db.delete_column('companies_inquiry', 'name')

        # Deleting field 'Inquiry.email'
        db.delete_column('companies_inquiry', 'email')

        # Deleting field 'Inquiry.phone'
        db.delete_column('companies_inquiry', 'phone')

        # Deleting field 'Inquiry.country'
        db.delete_column('companies_inquiry', 'country')

        # Deleting field 'Inquiry.message'
        db.delete_column('companies_inquiry', 'message')
